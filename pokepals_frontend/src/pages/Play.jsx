        ...
        <div className="row justify-content-center">
          ...
          { info &&
            <div id='info2' className="col-sm-3 pokemon-font">
              <p>Instructions for 'Play': A number will appear next to your Pokémon. You have to guess if the next number that appears is higher or lower than the first number. Winning makes your Pokémon happy, losing makes them sad!</p>
            </div>
          }
        </div>
      </div>
